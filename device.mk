...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/idc/fts_ts2.idc:system/usr/idc/fts_ts2.idc \
    ...
    $(LOCAL_PATH)/keylayout/fts_ts2.kl:system/usr/keylayout/fts_ts2.kl \
    $(LOCAL_PATH)/keylayout/i-rocks_Bluetooth_Keyboard.kl:system/usr/keylayout/i-rocks_Bluetooth_Keyboard.kl

# Prebuilt
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/asus/rog5/prebuilt/system,system) \
    $(call find-copy-subdir-files,*,device/asus/rog5/prebuilt/root,recovery/root) \
    $(call find-copy-subdir-files,*,device/asus/rog5/prebuilt/system_root,root)
...
# Vibrator
PRODUCT_PACKAGES += \
    android.hardware.vibrator@1.2-service.rog5
...
$(call inherit-product, vendor/asus/rog5/rog5-vendor.mk)